...
$("<span class=\"tree-indent\"></span>").prependTo(node); _163.state = "open";
node.next().remove();
}
_127(_161,_163);
...
//var _35b=_356.pop();
var _35b=_356.length?_356[_356.length-1]:null;
if(_35b){
_34a(_354,_35b);
}else{
if(tabs.length){
...
var tr=opts.finder.getTr(_78d, _790,"body",(_78f ? 1 : 2));//add by ÂäÑô 2016-02-20
for(var i=0;i<_78e.length;i++){
var _793=_78e[i];
var col=$(_78d).datagrid("getColumnOption",_793);
var oldColObj = tr.find("td[field='" + _793 + "']"), isHidden = oldColObj.is(":hidden");//add by ÂäÑô 2017-12-07
var oldColspan, oldRowspan;//add by ÂäÑô 2016-02-20
if (!isHidden) { oldColspan = oldColObj.attr("colspan"), oldRowspan = oldColObj.attr("rowspan"); }//add by ÂäÑô 2017-12-07
if(col){
var _794=_791[_793];
...
var _797=(col.hidden||isHidden)?"style=\"display:none;"+_796+"\"" : (_796?"style=\""+_796+"\"" : "");
var colspan=oldColObj.length && oldColspan!=undefined && oldColspan!=""?"colspan=\""+oldColspan+"\"" : "";//add by ÂäÑô 2016-02-20
var rowspan=oldColObj.length && oldRowspan!=undefined && oldRowspan!=""?"rowspan=\""+oldRowspan+"\"" : "";//add by ÂäÑô 2016-02-20
//cc.push("<td field=\""+_793+"\" "+cls+" "+_797+">");
cc.push("<td field=\""+_793+"\" "+cls+" "+_797+" "+colspan+" "+rowspan+">");
var _797="";
if(!col.checkbox){
if(col.align){
